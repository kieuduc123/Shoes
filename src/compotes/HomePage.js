    ...
    return (
        <Fragment>
            <div classNameName="mt-0 overflow-hidden ">
                                    ...
                                    <div className="w-100 h-100 overflow-hidden position-absolute z-index-1 top-0 start-0 end-0 bottom-0">
                                        <div
                                            ...
                                            style={{
                                                ...
                                                backgroundImage: `url(./assets/images/banners/banner-1.jpg)`,
                                            }}
                                        ></div>
                                    </div>
                ...
                <div
                    className="brand-section container-fluid"
                    data-aos="fade-in"
                >
                ...
                {/* <div className="container-fluid">
                                    ...
                                    >
                                        <picture className="d-block mb-4 img-clip-shape-one">
                                            <img
                                                className="w-100"
                                                title=""
                                                src="./assets/images/categories/products-7.jpg"
                                    ...
                                    >
                                        <picture className="d-block mb-4 img-clip-shape-one">
                                            <img
                                                className="w-100"
                                                title=""
                                                src="./assets/images/categories/products-2.jpg"
                                                alt="HTML Bootstrap Template by Pixel Rocket"
                                            />
                                        </picture>
                                        <p className="title-small mb-2 text-muted">
                                    ...
                                    >
                                        <picture className="d-block mb-4 img-clip-shape-one">
                                            <img
                                                className="w-100"
                                                title=""
                                                src="./assets/images/categories/products-3.jpg"
                                                alt="HTML Bootstrap Template by Pixel Rocket"
                                            />
                                        </picture>
                                        <p className="title-small mb-2 text-muted">
                    ...
                    <div className="position-relative row my-lg-7 pt-5 pt-lg-0 g-8">
                        <div
                            className="bg-text bottom-0 start-0 end-0"
                            data-aos="fade-up"
                        >
                            <h2 className="bg-text-title opacity-10">
                                <span className="text-outline-dark">Old</span>
                                Skool
                            </h2>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <h3 className="display-3 fw-bold mb-5">
                                ...
                                - streetwear & footwear specialists
                            </h3>
                            <p className="lead">
                                We are OldSkool, NavLink leading supplier of
                                global streetwear brands, including names such
                                as <NavLink to="/products">Stussy</NavLink>,{" "}
                                <NavLink to="/products">Carhartt</NavLink>,{" "}
                                <NavLink to="/products">Gramicci</NavLink>,{" "}
                                <NavLink to="/products">Afends</NavLink> and
                                many more.
                            </p>
                            <p className="lead">
                                With worldwide shipping and unbeatable prices -
                                now's NavLink great time to pick out something
                                from our range.
                            </p>
                            <NavLink
                                to="/products"
                                ...
                                <div className="position-absolute top-0 bottom-0 start-0 end-0 d-flex justify-content-center align-items-center z-index-20">
                                    <div className="py-6 px-5 px-lg-10 text-center w-100">
                                        ...
                                        <p className="fs-5 fw-light text-white d-none d-md-block">
                                            Our yearly flash sale is now on!
                                            Grab yourself NavLink bargain from
                                            the world's leading streetwear
                                            brands.
                                        </p>
                                        <NavLink
                                            to="/products"
